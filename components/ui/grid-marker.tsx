    ...
    return (
        ...
        >
            <div className={cn("relative w-4 h-4 transition-transform duration-300", rotationClasses[position])}>
                {/* Segitiga Utama */}
                <div className="absolute inset-0 bg-marker-bg transition-all duration-300 [clip-path:polygon(50%_0%,0%_100%,100%_100%)] group-hover/marker:bg-indigo-600 dark:group-hover/marker:bg-purple-600 group-hover/marker:scale-110 group-hover/marker:animate-[pulse-scale_0.8s_ease-in-out_infinite]" />
